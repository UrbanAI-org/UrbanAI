...
const UserGuide = () => {
    ...
    return (
        ...
        <div className="UserGuide">
            ...
            <h1>User Guide</h1>
            <details>
                <summary>Click here to view the Current Capabilities</summary>
            ...
            <details>
                <summary>Click here to view Getting Started</summary>
            ...
            <details>
                <summary>Click here to view the Polygon Mesh Type</summary>
            ...
            <details>
                <summary>Click here to view the Centre Point Square Mesh Type</summary>
            ...
            <details>
                <summary>Click here to view the Using the App</summary>
